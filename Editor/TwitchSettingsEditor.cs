...
[CustomEditor(typeof(TwitchSettings))]
public class TwitchSettingsEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (!useAnonymousConnectionProp.boolValue)
        {
            ...
            oAuthTokenProp.stringValue = showPassword
                ...
                : EditorGUILayout.PasswordField(new GUIContent("OAuth Token", "Retrieved from the App authorization"),
                    oAuthTokenProp.stringValue);

            showPassword = EditorGUILayout.ToggleLeft(new GUIContent("Show Token", "Caution: Token should be private"),
